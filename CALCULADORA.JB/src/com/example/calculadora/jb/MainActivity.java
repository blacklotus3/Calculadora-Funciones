package com.example.calculadora.jb;
...
public class MainActivity extends Activity {
	...
	private double rtrigonometrica;
    ...
    {  	
		...
		case 4 : //seno
			try 
			{ 
			rtrigonometrica= Math.sin(Double.parseDouble(_edit.getText().toString()));
			_edit.setText(String.valueOf(rtrigonometrica));
}
       	...
       	case 5:	// coseno
			try
			{
				rtrigonometrica=Math_sin(Double.parse(_edit.getText().toString()));
				edit.setText(String.valueOf(rtrigonometrica));
			}
			catch (Exception e)
			{
				_edit.setTextColor(Color.RED);
